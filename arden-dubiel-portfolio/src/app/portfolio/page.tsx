...
const allSkills = [
  ...
  <section className="flex flex-col md:flex-row items-center justify-between w-full max-w-6xl px-6 md:px-10 pb-16">
    ...
    <div className="md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left mb-10">
      ...
      <p className="text-lg leading-relaxed text-gray-700">
        I graduated in 2025 with a degree in Web Design and Development and bring a year of hands-on experience through my internship and other web design related roles.
      ...
      <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-10 pb-6">
        <a className="flex-1 px-4 py-2 bg-black border-4 border-transparent hover:bg-white transition hover:border-[#b77574] hover:border-4 hover:text-black text-white text-xl md:text-2xl rounded" href="https://www.behance.net/ardend" target="_blank">Behance</a>
  ...
  <section className="w-full max-w-6xl px-6 md:px-10 py-16">
    ...
    <p className="text-lg text-gray-700 mb-10 text-center md:text-left">
      A few live projects I’ve had the oppportunity to work on.
    </p>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 ">
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col">
        ...
        <div className="p-4 flex flex-col flex-1">
          ...
          <p className="text-gray-600 flex-1 mb-4">
            As an intern, I led a website refresh with guidance from the senior web designer. I presented the redesign to the marketing team, implemented site-wide design updates, Improved SEO, and designed and developed the “Our Work” blog page.
          </p>
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col">
        ...
        <div className="p-4 flex flex-col flex-1">
          ...
          <p className="text-gray-600 flex-1 mb-4">
            Built a full-stack health and nutrition tracking web app using React, Tailwind CSS, PostgreSQL, and Prisma. The project includes user authentication, a connected database, a profile settings page and a food tracker that logs nutrients.          </p>
          <a
